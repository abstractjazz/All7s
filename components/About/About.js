...
export default function About({sectionCopy}) {
  return (
  <>
      <div className="absolute w-screen h-screen z-20 text-[6rem]">
        <div className="w-full h-full flex content-center justify-center align-middle items-center font-bold px-24 text-transparent bg-clip-text bg-gradient-to-r from-pink-600 via-blue-300 to-purple-600 mt-24">
